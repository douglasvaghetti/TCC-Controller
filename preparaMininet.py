...
if __name__ == "__main__":
    ...
    n = 0
    controladoresPorSW = {}
    os.system("/home/mininet/pox/pox.py log.level --INFO openflow.of_01 --port=%d --address=10.0.0.5  forwarding.l2_learning  &"%(6634))
    os.system("/home/mininet/pox/pox.py log.level --INFO openflow.of_01 --port=%d --address=10.0.0.5 misc.matador_de_passarinho --webServerPort=%d &"%(6635,6670))
    time.sleep(1)
